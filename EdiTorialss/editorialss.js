...
let url = `https://newsapi.org/v2/everything?domains=techcrunch.com,thenextweb.com&apiKey=8ce21546228440919b644eb19af543db`
...
let displayLeft = async () => {
    ...
    second.innerHTML = `<h5 class="AllignLeft"><span class="brackets">Home</span> / EDITORIALS</h5>
    <h2 class="heading-css"><span class="brackets">[</span>EDITORIALS<span class="brackets">]</span></h2>
    <div id="BigDiv"></div>
    <div id="SmallDiv"></div>`;
